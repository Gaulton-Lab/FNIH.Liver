...
SC_FP='/tscc/projects/ps-epigen/users/cmiciano/Liver/RNA/outputs/sandbox/spatial/20241112_tangram_preprocessing_genelist50_liver_normal_rem_mast/Preprocessed_adsc.h5ad'
# broad celltypes rank genes
MARKERS='/tscc/projects/ps-epigen/users/cmiciano/Liver/RNA/outputs/sandbox/spatial/20241112_tangram_preprocessing_genelist50_liver_normal_rem_mast/markers'
...
# 21-33 for QY_2673
#JOBID_3=$(sbatch --export=OUT_DIR=${OUT_DIR},CELLTYPE_MD_COL=${CELLTYPE_MD_COL},JOB_OUT=${JOB_OUT},PATIENT_ID=${PATIENT_ID} --output="${JOB_OUT}pp_arr_${PATIENT_ID}.e-%a" --output="${JOB_OUT}pp_arr_${PATIENT_ID}.o-%a" --array=21-33 Tangram_postPrediction_arr.sh | awk '{print $4}')
